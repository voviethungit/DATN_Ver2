            ...
            <div className='content-box'>
                ...
                <div className='mytrips-mode'>
                    <div className='mytrips-mode-tab'>
                        <Link className='userinfor-nav-link mytrips-link active'>Chuyến hiện tại</Link>
                        <Link className='userinfor-nav-link mytrips-link'>Lịch sử chuyến</Link>
                    </div>
                </div>
                <div className='myfavs-cars'>
                    <img src="https://www.mioto.vn/static/media/empty-trip.8f191e42.svg" alt=''></img>
